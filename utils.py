"""Utilities for Maps"""
# Nitish Gourishetty and Neil Pendyala Period 3
...
def mean(s):
    ...
    """
    # BEGIN Question 1
    assert len(s) > 0, "Input must be postive (greater than 0) !!!!! :) :) :)"
    #could use sum(s) instead of reduce, but I think its preferred to do this for this assignment
    #reduce takes iterative thing first
